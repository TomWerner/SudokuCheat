 ...
 * <p>
 * This class is quite similar to java.awt.Point2D. Only the abstract superclass for all objects that store a 2D
 * coordinate. The actual storage representation of the coordinates is left to the subclass.
 */
...
public abstract class Point2D // implements Cloneable
{
    ...
    public static class Float extends Point2D
    {
         ...
         * 
         * @param x
         *            , y the coordinates to which to set the newly constructed <code>Point2D</code>
         */
         ...
         * 
         * @param x
         *            , y the coordinates to which to set this <code>Point2D</code>
         */
    ...
    /**
     * Sets the location of this <code>Point2D</code> to the same coordinates as the specified <code>Point2D</code>
     * object.
     * 
     * @param p
     *            the specified <code>Point2D</code> the which to set this <code>Point2D</code>
     */
     ...
     * 
     * @param PX
     *            , PY the coordinates of the specified <code>Point2D</code>
    ...
    /**
     * Determines whether or not two points are equal. Two instances of <code>Point2D</code> are equal if the values of
     * their <code>x</code> and <code>y</code> member fields, representing their position in the coordinate space, are
     * the same.
     * 
     * @param obj
